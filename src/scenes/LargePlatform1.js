class LargePlatform1 extends Phaser.Scene {
    constructor() {
        super("largePlatformScene1");
    ...
    create() {
        ...
        const transportLayer = map.createStaticLayer("Transport", tileset, 0, 0);
        
        // set map collision 
        groundLayer.setCollisionByProperty({ collides: true });
        slipgroundLayer.setCollisionByProperty({ slide: true });
        transportLayer.setCollisionByProperty({ Transport: true });
        ...
        // set up clock item
        this.clock = this.physics.add.sprite(364, 76, "clock");
        ...
        this.physics.add.collider(this.p1, transportLayer, this.transportCollision, null, this);
